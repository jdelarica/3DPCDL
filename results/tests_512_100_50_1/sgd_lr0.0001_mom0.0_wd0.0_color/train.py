...
rotate = 1.0
scale = 0.5
outdir = '/imatge/jdelarica/work/PycharmProjects/TFG/tests_512_100_50_1/sgd_lr0.0001_mom0.0_wd0.0_color_V2'
...
dataset = {}
dataloader = {}
dataset['train'] = datasets.FreiburgRGBDDataset('data',mode='train',color=True, transform=None, seed=42)
