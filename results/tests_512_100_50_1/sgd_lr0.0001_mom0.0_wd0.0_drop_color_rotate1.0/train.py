...
rotate = 1.0
scale = 0.5
outdir = '/imatge/jdelarica/work/PycharmProjects/TFG/tests_512_100_50_1/sgd_lr0.0001_mom0.0_wd0.0_drop_color_rotate1.0_V2'
...
#if scale:
#    scale_transform = datasets.RandomScale(p=scale)
#else:
#    scale_transform = None
dataset = {}
dataloader = {}
dataset['train'] = datasets.FreiburgRGBDDataset('data',mode='train',color=True, transform=rotate_transform, seed=42)
dataloader['train'] = DataLoader(dataset['train'], batch_size=16, shuffle=True, num_workers=0)
dataset['val'] = datasets.FreiburgRGBDDataset('data',mode='val',color=True, seed=42)
