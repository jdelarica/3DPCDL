...
color = False
rotate = 1.0
outdir = '/imatge/jdelarica/work/PycharmProjects/TFG/tests/sgd_lr0.0001_mom0.0_wd0.0_drop'
...
dataset = {}
dataloader = {}
dataset['train'] = datasets.FreiburgRGBDDataset('data',mode='train',color=None, transform=None, seed=42)
dataloader['train'] = DataLoader(dataset['train'], batch_size=16, shuffle=True, num_workers=0)
dataset['val'] = datasets.FreiburgRGBDDataset('data',mode='val',color=None, seed=42)
