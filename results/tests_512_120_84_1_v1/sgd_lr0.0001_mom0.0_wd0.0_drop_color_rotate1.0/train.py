...
color = True
rotate = 1.0
outdir = 'tests/sgd_lr0.0001_mom0.0_wd0.0_drop_color_rotate1.0'
...
dataset = {}
dataloader = {}
dataset['train'] = datasets.FreiburgRGBDDataset('data',mode='train',color=color, transform=rotate_transform, seed=42)
