...
#
# train.py trains the selected network from the networks.py file for 1000 epochs.
# It computes the loss and accuracy for each epoch, and saves all the results together with the 
# loss and accuracy PNG files in the selected folder.
#
...
rotate = 1.0
scale = 0.5
outdir = '/imatge/jdelarica/work/PycharmProjects/TFG/tests_512_100_50_1/sgd_lr0.0001_mom0.0_wd0.0_drop'
...
dataset = {}
dataloader = {}
dataset['train'] = datasets.FreiburgRGBDDataset('data',mode='train',color=False, transform=None, seed=42)
dataloader['train'] = DataLoader(dataset['train'], batch_size=16, shuffle=True, num_workers=0)
dataset['val'] = datasets.FreiburgRGBDDataset('data',mode='val',color=False, seed=42)
